      ...
      <div className="flex justify-between px-[10%] py-[6%]">
            ...
            <table className="w-full">
              ...
              <tbody className="text-center">
                {products.map((product) => (
                  <tr className="border-t border-gray-500" key={product._id}>
                    <td className="pt-2 pr-4">
                      <Image
                        ...
                        alt="product image"
                      />
                      <h3 className="text-sm text-start">{product.title}</h3>
                    </td>
        ...
        {!!cartProducts?.length && (
          <div className="box flex flex-col gap-2 ml-[5%]">
            <h2 className="text-2xl font-bold pb-4">Order information</h2>
            <Input
              value={name}
            ...
            <button onClick={goToPayment} className="btn-secondary mt-4">
              Continue to payment
            </button>
          </div>
        )}
